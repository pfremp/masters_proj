...
def populate():
    ...
    exp7 = add_exp(name='Anxiety and performance in driving', long_description="Want to help research into driving anxiety? Researchers at the University of Nottingham are looking for participants to complete an online survey into driving behaviours and their relationship with anxiety. It takes up to 30 minutes to complete and you could win 50 in love2shop vouchers.", duration=120, researcher=res1, address="147 Cumberland Street, Glasgow, G5 9QA", url='http://google.com', city=None, is_full=False, has_ended=False, is_featured=False, online=False, student_only=False)
    ...
    app3 = add_app(status='Unsuccessful', researcher=res1, participant=par1, experiment=exp7, timeslot=ts7)
    ...
    app5 = add_app(status='Unsuccessful', researcher=res1, participant=par2, experiment=exp7, timeslot=ts20)
