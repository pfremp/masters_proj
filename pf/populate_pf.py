...
def add_exp(name, short_description, long_description, date, start_time, end_time, duration, paid_event, currency, payment_amount, pmt_type, location, address, no_of_participants_wanted, researcher):
    e = Experiment.objects.get_or_create(name=name, short_description=short_description, long_description=long_description, date=date, start_time=start_time, end_time=end_time, duration=duration, paid_event=paid_event, currency=currency,payment_amount=payment_amount, pmt_type=pmt_type, location=location, address=address, no_of_participants_wanted=no_of_participants_wanted, researcher=researcher)[0]
    e.save()
    return e
