...
def add_exp(name, short_description, long_description, duration, address, city, url, researcher):
    e = Experiment.objects.get_or_create(name=name, short_description=short_description, long_description=long_description, duration=duration,  address=address, city=city, url=url, researcher=researcher)[0]
    e.save()
    return e
